...
from api import songs, search, home, artist, album
...
app.include_router(artist.router, prefix=prefix, tags=["artist"])
app.include_router(album.router, prefix=prefix, tags=["album"])